...
public enum DefinitionClassEnum {
     ...
     * <p>
     * A definition of this class will evaluate to true when the specified software is found on the system. Another
     * way of thinking about this is that an inventory definition is stating "the software is installed if ...".
     * */
